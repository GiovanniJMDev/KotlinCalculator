...
fun CalculatorApp() {
    ...
    var result by remember { mutableStateOf("") } // Almacenar el resultado como String
    ...
    Column(
        ...
        OutlinedTextField(
            ...
            onValueChange = { newValue ->
                if (isValidNumber(newValue)) { // Solo actualiza si es un número válido
                    number1 = newValue
                }
            },
            label = { Text("Número 1") },
        ...
        Button(
            onClick = {
                // Convertir los valores a BigDecimal (o usar 0 si no son válidos)
